    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <Card className="divine-border">
          <CardHeader>
            <div className="flex items-center">
              <Moon className="h-8 w-8 text-saffron mr-3" />
              <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-start">
                  <Star className="h-4 w-4 text-saffron mr-2 flex-shrink-0 mt-0.5" />
        ...
        <Card className="divine-border">
          <CardHeader>
            <div className="flex items-center">
              <Sun className="h-8 w-8 text-saffron mr-3" />
              <div>
      ...
      <Card className="divine-border bg-saffron/5">
        <CardHeader>
          <CardTitle className="text-maroon flex items-center">
            <Calendar className="h-6 w-6 text-saffron mr-2" />
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-white rounded-lg border border-saffron/20">
